...
pub struct AppData {
    ...
    pub commodities: Vec<Map<String, Value>>,
    pub special_items: Vec<Map<String, Value>>,
    ...
    pub commodity_sprites: BTreeMap<String, String>,
    pub special_item_sprites: BTreeMap<String, String>,
