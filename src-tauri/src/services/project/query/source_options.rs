...
static WELL_KNOWN_TAG_LABELS: &[(&str, &str, &str)] = &[
    ...
    (
        "no_bp",
        "无蓝图",
        "不存在单独的蓝图。注意，依然可能被蓝图包所包含。",
    ),
    (
        "no_drop",
        "不可掉落",
        "不会作为战斗掉落物生成，也不会在遗迹中找到或在打捞空间站找到。",
    ),
    ("no_drop_salvage", "打捞不掉落", "不会在残骸区找到。"),
    (
        "no_loss_from_combat",
        "战斗不损失",
        "仅适用于货物。不会因为舰队战斗损失。",
    ...
    (
        "rapid_reform",
        "快速重组",
        "仅适用于战机联队。理论上重整阵型时更快，但实际上效果非常不显著。",
    ),
    (
    ...
    (
        "hist1t",
        "历史学家 1",
        "让历史学家相关事件可能指出该组件的蓝图。较为稀有。",
    ),
    (
        "hist2t",
        "历史学家 2",
        "让历史学家相关事件可能指出该组件的蓝图。非常稀有。",
    ),
    (
        "hist3t",
        "历史学家 3",
        "让历史学家相关事件可能指出该组件的蓝图。极其稀有。",
    ),
    (
        "kanta_gift",
        "Kanta 赠礼",
        "仅适用于舰船。Kanta 将接受其作为礼物。",
    ),
    (
        "req_military",
        "需要军事市场",
    ...
    (
        "military",
        "军用品",
        "适用于商品或殖民地设施。表示商品是军用物资，或殖民地设施作为 patrol/military/command 中的二级。",
    ),
    ...
    (
        "meta",
        "代码适配商品",
        "仅适用于商品。用于适配代码的商品标签。不应该直接在游戏出现。",
    ),
    (
        "colony_item",
        "殖民地物品",
        "仅适用于特殊物品。可安装于殖民地设施的物品。",
    ),
    (
        "mission_item",
        "任务物品",
    ...
    (
        "single_bp",
        "单项蓝图",
        "仅适用于特殊物品。用于适配代码的商品标签。不应该直接在游戏出现。",
    ),
    (
        "package_bp",
        "蓝图包",
    ...
    (
        "pather1",
        "左径兴趣 1",
        "仅适用于特殊物品。卢德左径兴趣等级标签，数字越大兴趣越高，范围仅限 1/2/4/6/8/10。",
    ),
    (
        "pather2",
        "左径兴趣 2",
    ...
    (
        "battlestation",
        "战斗空间站",
        "仅适用于殖民地设施。和 station 同时使用时，表示空间站是二级战斗空间站。",
    ),
    (
        "starfortress",
        "星堡",
        "仅适用于殖民地设施。和 station 同时使用时，表示空间站是三级星堡。",
    ),
    (
        "station",
        "空间站",
        "仅适用于殖民地设施。表示这是一种空间站，并且会产生附属空间站实体。",
    ),
    (
        "industry",
        "工业设施",
        "仅适用于殖民地设施。需要占用工业设施位置数。",
    ),
    (
        "structure",
        "常规设施",
        "仅适用于殖民地设施。不需要占用工业设施位置数。",
    ),
    (
        "industrial",
        "工业倾向",
        "仅适用于殖民地设施。让殖民地的被视作工业殖民地的因素增加。",
    ),
    (
        "rural",
        "乡村倾向",
        "仅适用于殖民地设施。让殖民地的被视作乡村殖民地的因素增加。",
    ),
    (
        "urban",
        "城市倾向",
        "仅适用于殖民地设施。让殖民地的被视作城市殖民地的因素增加。",
    ),
    (
        "unraidable",
        "不可劫掠",
    ...
    (
        "parent_item",
        "父设施",
        "仅适用于殖民地设施。该设施在建造界面中被视作 '一类' 殖民地设施的统一入口。",
    ),
    (
        "sub_item",
        "子设施",
        "仅适用于殖民地设施。该设施在建造界面中被视作 '一类' 的殖民地设施入口内的次级标签。",
    ),
    (
        "patrol",
        "巡逻",
        "仅适用于殖民地设施。作为 patrol/military/command 中的一级。",
    ),
    (
        "command",
        "指挥",
        "仅适用于殖民地设施。作为 patrol/military/command 中的三级。",
    ),
    (
        "cryorevival",
        "低温复苏设施",
        "仅适用于殖民地设施。低温复苏设施行业标签。",
    ),
    (
        "cryosanctum",
        "低温避难所",
    ...
    (
        "grounddefenses",
        "地面防御",
        "仅适用于殖民地设施。表示该设施具备提供地面防御能力加成的效果。",
    ),
    (
        "heavyindustry",
        "重工业",
    ...
    (
        "civ",
        "民用 D 插",
        "仅适用于舰船插件。与 dmod 同时使用时，让该 dmod 会在民用船上出现。",
    ),
    (
        "civ_package",
        "民用插件包",
    ...
    (
        "civOnly",
        "仅民用 D 插",
        "仅适用于舰船插件。与 dmod 同时使用时，让该 dmod 只会在民用船上出现，不会在非民用船上出现。",
    ),
    (
        "non_phase",
        "非相位",
    ...
    (
        "notPhase",
        "非相位 D 插",
        "仅适用于舰船插件。与 dmod 同时使用时，让该 dmod 不会在相位舰上出现。",
    ),
    (
        "notAuto",
        "非自动舰船 D 插",
        "仅适用于舰船插件。与 dmod 同时使用时，让该 dmod 不会在自动舰船上出现。",
    ),
    (
        "req_spaceport",
        "需要太空港",
        "仅适用于舰船插件。需要在太空港中才可安装或卸载。",
    ),
    (
        "reqShields",
        "需要护盾",
        "仅适用于舰船插件。需要舰船拥有护盾才可安装。",
    ),
    (
        "damageStruct",
        "结构伤害 D 插",
        "仅适用于舰船插件。相较于其它 dmod，有更高概率出现。",
    ),
    (
    ...
    (
        "phaseDamage",
        "相位 D 插",
        "仅适用于舰船插件。与 dmod 同时使用时，让该 dmod 只会在相位舰上出现。",
    ),
    (
        "phase_brawler",
        "相位搏斗者",
        "仅适用于舰船插件。让 AI 倾向于更积极的战斗方式。",
    ),
    (
        "peak_time",
        "峰值 D 插",
        "仅适用于舰船插件。与 dmod 同时使用时，让该 dmod 只会在有峰值时间限制的舰船上出现。",
    ),
    (
        "shrouded",
        "渊幕",
    ...
    (
        "fragment",
        "碎片",
        "仅适用于武器。接入集群威胁的碎片类武器机制。",
    ),
    (
        "fragment_glow",
        "碎片发光",
        "仅适用于武器。接入集群威胁的碎片类武器机制，且碎片发光。",
    ),
    ("lidar", "激光雷达", "仅适用于武器。激光雷达武器标签。"),
    (
        "LR",
        "远程",
        "仅适用于武器。让 AI 倾向于和其它远程武器分为同一武器组。",
    ),
    (
        "SR",
        "近程",
        "仅适用于武器。让 AI 倾向于和其它近程武器分为同一武器组。",
    ),
    (
        "pusherplate",
        "推力板",
        "仅适用于武器。该武器是某种猎户座驱动式战术系统的推力板。",
    ),
    (
        "reload_1pt",
        "导弹装填机 1 消耗",
        "仅适用于武器。当导弹自动装填机恢复其备弹量时，固定消耗 1 点资源。",
    ),
    (
        "reload_1_and_a_half_pt",
        "导弹装填机 1.5 消耗",
        "仅适用于武器。当导弹自动装填机恢复其备弹量时，固定消耗 1.5 点资源。",
    ),
    (
        "reload_2pt",
        "导弹装填机 2 消耗",
        "仅适用于武器。当导弹自动装填机恢复其备弹量时，固定消耗 2 点资源。",
    ),
    (
        "reload_3pt",
        "导弹装填机 3 消耗",
        "仅适用于武器。当导弹自动装填机恢复其备弹量时，固定消耗 3 点资源。",
    ),
    (
        "reload_4pt",
        "导弹装填机 4 消耗",
        "仅适用于武器。当导弹自动装填机恢复其备弹量时，固定消耗 4 点资源。",
    ),
    (
        "reload_5pt",
        "导弹装填机 5 消耗",
        "仅适用于武器。当导弹自动装填机恢复其备弹量时，固定消耗 5 点资源。",
    ),
    (
        "reload_6pt",
        "导弹装填机 6 消耗",
        "仅适用于武器。当导弹自动装填机恢复其备弹量时，固定消耗 6 点资源。",
    ),
    (
        "no_reload",
        "不适用于导弹装填机",
...
static WELL_KNOWN_HINT_LABELS: &[(&str, &str, &str)] = &[
    ...
    (
        "GUIDED_POOR",
        "弱制导",
        "仅适用于武器。DO_NOT_AIM 的弱化版，让 AI 认为目标在一定角度范围内即可开火。",
    ),
    (
        "HEATSEEKER",
        "追尾",
        "仅适用于武器。让 AI 认为这种武器发射的弹体会追尾目标的引擎。对于导弹武器，将修改其飞行 AI 为追尾。",
    ),
    (
        "MISSILE_SPREAD",
        "导弹散开",
