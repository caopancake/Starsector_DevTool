...
import { getAssociatedFileCandidates as collectAssociatedFileCandidates, isAssociatedFileForTable } from './associated-file-candidates';
import { saveTableRows } from './table-service';
import { TABLE_KEYS, useTablesStore } from './tables-store';
import { useTablesEditHistoryStore } from './tables-edit-history-store';
import { resolveTableRowKey } from './table-row-key';

export type TableSaveResult = 'saved' | 'noop';

export function getAssociatedFileCandidates(appData: AppData | null) {
