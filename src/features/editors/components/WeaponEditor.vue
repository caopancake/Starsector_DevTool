...
import { useCanvasDrawing } from '../composables/use-canvas-drawing';
import { useCanvasViewport } from '../composables/use-canvas-viewport';
import { useHistory } from '../composables/use-history';
import { useEditorShortcuts } from '../composables/use-editor-shortcuts';
