...
- [CSV 读取与写入 parser](modules/csv-parser.md)：说明 Rust CSV parser 的读取、空行保留和写回规则。
- [Starsector 宽松 JSON parser](modules/starsector-json-parser.md)：说明 Starsector JSON-like 清洗、解析和错误边界。
